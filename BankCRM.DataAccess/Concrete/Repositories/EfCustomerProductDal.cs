...
{
    public class EfCustomerProductDal : EfGenericRepository<CustomerProduct>, ICustomerProductDal
    {
        public EfCustomerProductDal(BankCrmContext context) : base(context)
        {
        }
    }
}
